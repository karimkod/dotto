...
class _LevelDesignerScreenState extends State<LevelDesignerScreen> {
  ...
  final Map<ToolType, int> _kit = {
    ...
    ToolType.oneShotUp: 0,
    ToolType.oneShotDown: 0,
    ToolType.oneShotLeft: 0,
    ToolType.oneShotRight: 0,
    ToolType.shield: 0,
    ToolType.pause: 0,
  ...
  String _kitLabel(Map<ToolType, int> kit) {
    ...
    String name(ToolType t) => switch (t) {
          ...
          ToolType.oneShotUp => '1× Up',
          ToolType.oneShotDown => '1× Down',
          ToolType.oneShotLeft => '1× Left',
          ToolType.oneShotRight => '1× Right',
